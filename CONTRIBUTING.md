...
```shell
go run ./cmd/apicr service-registry
```
...
Once pushed, a [GitHub Action](https://github.com/apicurio/apicurio-cli/actions/workflows/release.yml) will create a release on GitHub and upload the binaries.
...
Run `./scripts/generate-changelog.sh` to output the changes between the current and last stable releases. Paste the output into the description of the [release on GitHub](https://github.com/apicurio/apicurio-cli/releases/tag/latest).
